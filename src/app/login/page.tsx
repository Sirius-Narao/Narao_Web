        ...
        <div className="bg-background text-foreground min-h-screen w-full pt-48">
            ...
            <div className="flex flex-col items-center justify-center gap-4">
                <FieldGroup className="w-full sm:w-[400px] md:w-[524px] mx-auto">
                    ...
                    <Button onClick={passwordIsValid() && emailIsValid() ? () => { signIn(); setClicked(true) } : () => { }} className={cn("transition-all duration-200", password.length < 8 || !/[A-Z]/.test(password) || !/[a-z]/.test(password) || !/[0-9]/.test(password) ? "opacity-50 cursor-not-allowed" : "", clicked ? "flex items-center gap-1" : "")}>
                        Sign In
